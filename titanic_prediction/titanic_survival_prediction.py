...
# Impute missing values (fit on train only, apply to val + test)
...
# Predict on test + make submission

test_preds = model.predict(test_imp)

submission = pd.DataFrame({
    "PassengerId": test_passenger_id, "Survived": test_preds})
